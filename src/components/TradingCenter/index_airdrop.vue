...
<script>
import tradHome from './tradQueue/home_airdrop.vue'          
...
export default {
  ...
  data(){
      return {
          ...
          sockePrice:"/AIRDROP"+this.$t("seo.a1"),
          FirstId:0,
          areaList:[],
          areaIndex:-1,
      }
  ...
  beforeRouteLeave(to,from,next){
      if(to.path!="/tradMoreRecode" && to.path!="/tradMoreDepth" && to.path!="/tradingCNHA"){
