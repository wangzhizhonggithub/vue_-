...
<script>
  ...
  export default {
    ...
    created() {
      ...
      } else if(localStorage.getItem("FirstId4")){
        this.btype = Number(localStorage.getItem("FirstId4"));
      } else {
        this.FetchGet(this.requestUrl.tradingCenter.bList)
          .then(res => {
            ...
            if (res.data['airdrop']) {
              ...
              this.areaIndex=Number(res.data['airdrop'][0].sorts)-1;
            }
            _this.init();
    ...
    methods: {
      ...
      getBlist() {
        ...
        this.FetchGet(this.requestUrl.tradingCenter.bList)
          .then(res => {
            ...
            _this.jFloal = Number(res.data.ETHjfloal);
            if (res.data['airdrop']) {
              _this.bList = res.data['airdrop'];
              if (localStorage.user) {
                ...
                var obj = res.data['airdrop'][bIndex]
                this.goods = res.data['airdrop'][bIndex].goods;
                if (obj.goldnum) {
      ...
      getRealList(id) {
        ...
        this.FetchPost(this.requestUrl.tradingCenter.RealList, { typeboxid: this.btype || 6 })
          .then(res => {
            //_this.Blist = res
      ...
      getKlineList(id) {
        ...
        this.FetchPost(this.requestUrl.tradingCenter.KineList, { typeboxid: this.btype || 6, time: time })
          .then(res => {
      ...
      getLogEntrust() {
        ...
        this.FetchGet(this.requestUrl.tradingCenter.logEntrust, params)
          .then(res2 => {
            if (res2.status == 200) {
              if (res2.data.pagedata.length >= 6) {
