...
<script>
  ...
  export default {
    ...
    created() {
      ...
      } else if(localStorage.getItem("FirstId3")){
        this.btype = Number(localStorage.getItem("FirstId3"));
      } else {
          ...
          .then(res => {
            ...
            if (res.data['ETH']) {
              ...
              if (localStorage.user) {
                ...
                var obj = res.data['ETH'][bIndex]
                this.goods = res.data['ETH'][bIndex].goods;
                if (obj.goldnum) {
