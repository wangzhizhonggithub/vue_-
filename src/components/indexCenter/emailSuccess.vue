<template>
    <div class="emailBox">
            ...
            <div class="set">
                 <h3>{{$t("e.a1")}}</h3>
                 <p><Icon type="checkmark-circled" size="23"></Icon><span style="margin-left:5px">{{$t("e.a2")}}</span></p>
                 <p><span style="color:red">{{count}}</span>{{$t("e.a3")}}<span style="color:#00aedd;cursor:pointer" @click="gologin">{{$t("e.a4")}}</span></p>
            </div>
    </div>
</template>
<script>
